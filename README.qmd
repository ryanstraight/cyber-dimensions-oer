...
::: {.implementation-guidance title="Coming soon!"}

This toolkit is a supplement to the [_Cyber Dimensions: Immersive Case Studies Across Digital Domains_ textbook](https://he.kendallhunt.com/product/cyber-dimensions-immersive-case-studies-across-digital-domains) published with Kendall Hunt. This Open Educational Resource (OER) is written as a Quarto book, available at [ryanstraight.github.io/cyber-dimensions-oer](https://ryanstraight.github.io/cyber-dimensions-oer).
:::
...
1. Visit the published guide at [ryanstraight.github.io/cyber-dimensions-oer](https://ryanstraight.github.io/cyber-dimensions-oer)
1. Try the [CIRCUIT demo case study](https://ryanstraight.github.io/cyber-dimensions-demo) to experience the methodology in action
1. Begin with the Introduction to understand the methodology overview
1. Explore the examples to see the approach in practice
...
3. Open .Rproj in RStudio (recommended; VS Code, Positron, and other IDEs also work)
...
4. Apply to Your Context by adapting the methodology to your specific needs
...
::: {.evidence-base title="License Terms"}
### You are free to:
...
- **Issues**: Report problems via [GitHub Issues](https://github.com/ryanstraight/cyber-dimensions-oer/issues)
